    ...
    <div className="min-h-screen bg-gray-50 dark:bg-[#0f1117]">
      ...
      <header className="bg-white dark:bg-[#1a1b2e] border-b border-gray-200 dark:border-gray-700 px-4 md:px-6 py-3 md:py-4">
        <div className="max-w-5xl mx-auto flex items-center gap-2 md:gap-4">
          <Link href="/" className="text-blue-600 hover:text-blue-800 font-bold text-base sm:text-lg shrink-0 font-nunito">Wocket</Link>
          <div className="flex-1 min-w-2" />
          <div className="w-full max-w-[200px] sm:max-w-sm min-w-0"><SearchBar /></div>
        </div>
      </header>
