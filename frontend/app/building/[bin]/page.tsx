    ...
    <div className="min-h-screen bg-gray-50 dark:bg-[#0f1117]">
      ...
      <main className="max-w-5xl mx-auto px-3 md:px-4 py-4 md:py-8 space-y-3 md:space-y-4">
        ...
        <div className="flex flex-wrap items-center gap-3 mb-1">
          ...
          <span className={`text-sm sm:text-base md:text-lg font-bold w-[26px] sm:w-[28px] md:w-[30px] aspect-square inline-flex items-center justify-center leading-none rounded-lg ${gradeColor(b.score_grade)}`}>{b.score_grade || "?"}</span>
          <Link
